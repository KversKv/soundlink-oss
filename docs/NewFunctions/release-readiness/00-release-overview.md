...
2. **测试基建缺失**：无 E2E（H5）、无长时压测（H7）；CI 流水线（H6）已实装，但 `cargo fmt` 步骤尚未阻塞化。
...
| H · 测试与稳定性 | 单测 / E2E / 压测 | P2 | 🟡 进行中 | 2026-08-03（H1-H4 完成，H6 CI 已实装，H5/H7 待） |
| I · 体验优化 | 快捷键 / i18n / 事件驱动 / 关于页 | P2 | 🟡 进行中 | 2026-07-12（I2/I4-I7 完成，I1/I3/I8 待） |
...
| `v0.2.0` | 跨平台 Beta | P1 全部 + macOS 采集初版 + i18n（I3） | ⬜ 未开始 |
