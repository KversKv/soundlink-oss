...
## 补充：docs/user 文档落地（2026-08-06 续）

- 新增 [`09-open-core-build.md`](../../user/09-open-core-build.md)：双仓库维护、免费/Pro 编译、junction 切换调试、CI 双流水线、构建排查表、维护红线速记。
- 新增 [`10-license-management.md`](../../user/10-license-management.md)：激活码生成（keygen/issue）、台账管理、换机重签、吊销、密钥轮换、跨语言一致性自检。
- 同步修订：`00-index.md`（加两条索引）、`05-build.md`（双构建指引）、`06-debug.md`（Pro/授权问题定位）、`desktop-guide.md`（§4.1 启动标注 Pro、新增 §4.6 授权与 §4.7 配置档、关联文档）。
