...
export const zh = {
  ...
  quickResolution: {
    badge: 'Pro',
    title: '快速分辨率切换',
    body: '游戏要 2560×1080 高刷、观影回 3440×1440 满血——不用翻系统设置层层菜单。预设常用分辨率档位，托盘右键一键切换。',
    points: [
      '预设多个分辨率 / 刷新率档位，拖拽排序，可从系统可用模式一键导入',
      '托盘右键菜单一键切换；切换后 15 秒确认窗，超时自动回滚防黑屏',
      '退出软件时可自动恢复原始分辨率',
    ],
    note: '仅 Windows 官方版本提供；NVIDIA 自定义分辨率与 EDID 预置为实验能力，默认关闭。',
    settingsShotSrc: ASSET('assets/desktop-quick-resolution.png'),
    settingsShotAlt: '桌面端设置页「快速分辨率切换」：显示器选择、档位列表与切换选项',
    trayShotSrc: ASSET('assets/tray-quick-resolution.png'),
    trayShotAlt: '托盘右键菜单中的「快速分辨率切换」二级菜单，按显示器分组列出档位',
  },
  how: {
    title: '工作原理',
    steps: [
