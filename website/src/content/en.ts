...
export const en: Content = {
  ...
  links: {
    ...
    docs: `${REPO}/blob/main/docs/user/user-readme.md`,
    guide: './guide/',
    pro: PRO_STORE,
  },
  nav: {
  ...
  quickResolution: {
    badge: 'Pro',
    title: 'Quick resolution switching',
    body: 'Need 2560×1080 high-refresh for gaming, then back to full 3440×1440 for movies? Skip the system settings maze — preset your resolutions and switch from the tray with one click.',
    points: [
      'Preset resolution / refresh-rate modes, drag to reorder, or import from system modes in one click',
      'One-click switching from the tray menu; a 15-second confirm window auto-reverts on timeout to prevent black screens',
      'Optionally restore the original resolution on exit',
    ],
    note: 'Windows official build only. NVIDIA custom resolutions and EDID presets are experimental and off by default.',
    settingsShotSrc: ASSET('assets/desktop-quick-resolution.png'),
    settingsShotAlt: 'Desktop settings page "Quick resolution switching": monitor picker, mode list and switch options',
    trayShotSrc: ASSET('assets/tray-quick-resolution.png'),
    trayShotAlt: 'Tray right-click menu "Quick resolution switching" submenu listing modes grouped by monitor',
  },
  how: {
    title: 'How it works',
    steps: [
